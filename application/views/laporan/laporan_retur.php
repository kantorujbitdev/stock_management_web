<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="<?php echo site_url('laporan_retur/export_pdf?' . $_SERVER['QUERY_STRING']); ?>" class="btn btn-danger btn-sm">
                <i class="fas fa-file-pdf"></i> Export PDF
            </a>
            <a href="<?php echo site_url('laporan_retur/export_excel?' . $_SERVER['QUERY_STRING']); ?>" class="btn btn-success btn-sm">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control">
                            <option value="">-- Semua --</option>
                            <option value="diterima" <?php echo ($filter['status'] == 'diterima') ? 'selected' : ''; ?>>Diterima</option>
