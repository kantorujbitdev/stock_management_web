<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="row">
            <div class="col">
                <h6 class="m-0 font-weight-bold text-primary">Daftar Transfer Stok</h6>
            </div>
            ...
            <tbody>
                ...
                foreach ($transfer as $t): ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($t->status == 'pending'): ?>
                                <a href="<?php echo site_url('transfer/approve/' . $t->id_transfer); ?>"
                                    class="btn btn-success btn-sm"
                                    onclick="return confirm('Apakah Anda yakin ingin menyetujui transfer ini?')">
                                    <i class="fas fa-check"></i>
                                </a>
                                <a href="<?php echo site_url('transfer/reject/' . $t->id_transfer); ?>"
                                    class="btn btn-danger btn-sm"
                                    onclick="return confirm('Apakah Anda yakin ingin membatalkan transfer ini?')">
