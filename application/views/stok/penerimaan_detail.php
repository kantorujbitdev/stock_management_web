    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <?php if ($penerimaan->status == 'draft'): ?>
                <a href="<?php echo site_url('penerimaan/proses/' . $penerimaan->id_penerimaan); ?>" class="btn btn-success btn-sm" onclick="return confirm('Apakah Anda yakin ingin memproses penerimaan ini?')">
                    <i class="fas fa-check"></i> Proses
                </a>
                <a href="<?php echo site_url('penerimaan/batal/' . $penerimaan->id_penerimaan); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin membatalkan penerimaan ini?')">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_barang" class="form-control" required>
                                ...
                                <?php foreach ($barang as $b): ?>
                                    <option value="<?php echo $b->id_barang; ?>"><?php echo $b->nama_barang; ?> - <?php echo $b->sku; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php if ($penerimaan->status == 'draft'): ?>
                    <td>
                        <a href="<?php echo site_url('penerimaan/delete_barang/' . $d->id_detail . '?id_penerimaan=' . $penerimaan->id_penerimaan); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus barang ini?')">
