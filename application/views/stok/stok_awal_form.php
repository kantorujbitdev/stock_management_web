<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select name="id_perusahaan" class="form-control <?php echo form_error('id_perusahaan') ? 'is-invalid' : ''; ?>" id="id_perusahaan" required>
        ...
        <div class="form-group">
            ...
            <select name="id_gudang" class="form-control <?php echo form_error('id_gudang') ? 'is-invalid' : ''; ?>" id="id_gudang" required disabled>
        ...
        <div class="form-group">
            ...
            <select name="id_barang" class="form-control <?php echo form_error('id_barang') ? 'is-invalid' : ''; ?>" id="id_barang" required disabled>
        ...
        <div class="form-group">
            ...
            <input type="number" name="qty_awal" class="form-control <?php echo form_error('qty_awal') ? 'is-invalid' : ''; ?>" 
        ...
        <div class="form-group">
            ...
            <textarea name="keterangan" class="form-control <?php echo form_error('keterangan') ? 'is-invalid' : ''; ?>" rows="3"><?php echo isset($stok_awal) ? $stok_awal->keterangan : ''; ?></textarea>
