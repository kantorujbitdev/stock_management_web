<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="<?php echo site_url('pengaturan/backup/create'); ?>" class="btn btn-primary btn-sm" onclick="return confirm('Apakah Anda yakin ingin membuat backup database sekarang?')">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('pengaturan/backup/download/' . $file); ?>" class="btn btn-success btn-sm">
                                    <i class="fas fa-download"></i> Download
                                </a>
                                <a href="<?php echo site_url('pengaturan/backup/delete/' . $file); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus file backup ini?')">
