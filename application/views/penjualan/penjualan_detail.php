    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <?php if ($penjualan->status == 'proses'): ?>
                <a href="<?php echo site_url('penjualan/proses/' . $penjualan->id_penjualan); ?>"
                    class="btn btn-warning btn-sm"
                    onclick="return confirm('Apakah Anda yakin ingin memproses penjualan ini?')">
                    <i class="fas fa-box"></i> Proses
                </a>
            <?php endif; ?>
            <?php if ($penjualan->status == 'packing'): ?>
                <a href="<?php echo site_url('penjualan/kirim/' . $penjualan->id_penjualan); ?>"
                    class="btn btn-primary btn-sm"
                    onclick="return confirm('Apakah Anda yakin ingin mengirim penjualan ini?')">
                    <i class="fas fa-truck"></i> Kirim
                </a>
            <?php endif; ?>
            <?php if ($penjualan->status == 'dikirim'): ?>
                <a href="<?php echo site_url('penjualan/selesai/' . $penjualan->id_penjualan); ?>"
                    class="btn btn-success btn-sm"
                    onclick="return confirm('Apakah Anda yakin ingin menyelesaikan penjualan ini?')">
                    <i class="fas fa-check"></i> Selesai
                </a>
            <?php endif; ?>
            <?php if ($penjualan->status != 'selesai' && $penjualan->status != 'batal'): ?>
                <a href="<?php echo site_url('penjualan/batal/' . $penjualan->id_penjualan); ?>"
            ...
            <tbody>
                ...
                foreach ($detail as $d): ?>
                    <tr>
                        ...
                        <?php if ($penjualan->status == 'proses'): ?>
                            <td>
                                <a href="<?php echo site_url('penjualan/delete_barang/' . $d->id_detail . '?id_penjualan=' . $penjualan->id_penjualan); ?>"
                                    class="btn btn-danger btn-sm"
