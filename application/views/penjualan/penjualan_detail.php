            ...
            <div class="card-body">
                ...
                <?php if ($penjualan->status == 'proses'): ?>
                    <a href="<?php echo site_url('penjualan/update_status/' . $penjualan->id_penjualan . '/batal'); ?>"
                        ...
                        onclick="return confirm('Apakah Anda yakin ingin membatalkan penjualan ini? Stok akan dikembalikan.')">
                        <i class="fas fa-ban"></i> Batal
                    </a>
                <?php endif; ?>

                <?php if ($this->session->userdata('id_role') == 3 || $this->session->userdata('id_role') == 5 || $this->session->userdata('id_role') == 1): ?>
                    <?php if ($penjualan->status == 'proses'): ?>
