                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_barang" class="form-control" id="id_barang" required>
                                    ...
                                    <?php foreach ($barang_penjualan as $b): ?>
                                        <option value="<?php echo $b->id_barang; ?>" data-gudang="<?php echo $b->id_gudang; ?>"
                                            data-jumlah="<?php echo $b->jumlah; ?>">
                                            <?php echo $b->nama_barang; ?> - <?php echo $b->sku; ?> (Jual:
                                            <?php echo $b->jumlah; ?>)
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="jumlah_retur" class="form-control" id="jumlah_retur" required
                                    min="1">
            ...
            <tbody>
                ...
                foreach ($detail as $d): ?>
                    <tr>
                        ...
                        <?php if ($retur->status == 'diterima'): ?>
                            <td>
                                <a href="<?php echo site_url('retur/delete_barang/' . $d->id_detail_retur . '?id_retur=' . $retur->id_retur); ?>"
