...
$route['penerimaan/edit/(:num)'] = 'stok/Penerimaan/edit/$1';
$route['penerimaan/delete/(:num)'] = 'stok/Penerimaan/delete/$1';

$route['transfer'] = 'stok/Transfer';
$route['transfer/add'] = 'stok/Transfer/add';
$route['transfer/edit/(:num)'] = 'stok/Transfer/edit/$1';
$route['transfer/delete/(:num)'] = 'stok/Transfer/delete/$1';

$route['penyesuaian'] = 'stok/Penyesuaian';
$route['penyesuaian/add'] = 'stok/Penyesuaian/add';
$route['penyesuaian/edit/(:num)'] = 'stok/Penyesuaian/edit/$1';
$route['penyesuaian/delete/(:num)'] = 'stok/Penyesuaian/delete/$1';
